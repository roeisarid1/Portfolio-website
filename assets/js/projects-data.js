...
const projects = [
  ...
  },
  {
    ...
    description:
      "A browser-based fantasy sports app for predicting WSL Championship Tour final rankings. Users pick Men's Top 5 and Women's Top 3 surfers in order, then earn points as the real season unfolds. Live rankings are fetched via a CORS proxy from worldsurfleague.com with JSON fallback. No backend — runs entirely in the browser with localStorage persistence.",
    techStack: [
      "Vanilla JS",
      "HTML/CSS",
      "localStorage",
    ...
    highlights: [
      "Pick Men's Top 5 & Women's Top 3 with position-based scoring",
      "Live WSL rankings fetch with graceful JSON fallback",
      "1-hour edit window then picks lock automatically",
      "Admin panel for manual ranking overrides",
      "Pure frontend — zero dependencies, zero backend",
      "Deployed on GitHub Pages",
    ],
    demonstrates:
      "Frontend architecture | Data-driven UI | State management | API integration | Sports logic modeling",
